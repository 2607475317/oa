...
public class ClaimVoucherController {
    ...
    public String add(HttpSession session, ClaimVoucherInfo info){
        Employee employee = (Employee)session.getAttribute("employee");//从session中获取信息
    ...
    public String detail(int id, Map<String,Object> map){
        map.put("claimVoucher",claimVoucherBiz.get(id));//报销单
        map.put("items",claimVoucherBiz.getItems(id));//报销单条目
        map.put("records",claimVoucherBiz.getRecords(id));//处理记录
